...
// render and animate the different pictures for coloring depending on order for lvl 1 + 2
    export function pictureselector(order) {

        switch (order) {
                  case 0:
                return <Animatable.Image
                    style={styles.pictures} animation="fadeIn" duration={6000} delay={2000} easing={"ease-in-cubic"} useNativeDriver={true}
            ...
            case 2:
                return <Animatable.Image
                    style={styles.pictures} animation="fadeIn" duration={6000} easing={"ease-in-cubic"} useNativeDriver={true}
